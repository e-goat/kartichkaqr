                ...
                >
                    ...
                    {#if pcs.requested}
                        ...
                        >
                            ...
                            >
                                <strong>Ценообразуване:</strong> Изработката на
                                персонализирана картичка е 5,99€.<br />
                                Доставката се изчислява отделно според адреса и тарифите
                                на куриерските фирми.
                            </p>
                        </div>
                        <div
